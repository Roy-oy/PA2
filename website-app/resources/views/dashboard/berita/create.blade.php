            ...
            <div class="mt-6 bg-gray-50 p-6 rounded-lg shadow-sm">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="isi_berita" id="isi_berita" rows="10" required
                        class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('isi_berita') border-red-500 @enderror">{{ old('isi_berita') }}</textarea>
                    @error('isi_berita')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
